...
GOOGLE_CLOUD_SDK_URL="https://dl.google.com/dl/cloudsdk/channels/rapid/downloads/google-cloud-sdk-495.0.0-linux-x86_64.tar.gz"
HELM_SCRIPT="https://raw.githubusercontent.com/helm/helm/main/scripts/get-helm-3"
GRAFANA_DEB_URL="https://dl.grafana.com/oss/release/grafana_12.1.3_amd64.deb"
GRAFANA_RPM_URL="https://dl.grafana.com/oss/release/grafana-12.1.3-1.x86_64.rpm"
...
declare -A binary_installs=(
  ...
  [gcloud]="curl -O $GOOGLE_CLOUD_SDK_URL && tar -xvzf google-cloud-sdk-495.0.0-linux-x86_64.tar.gz && ./google-cloud-sdk/install.sh"
  ...
  [vault]="curl -LO https://releases.hashicorp.com/vault/1.19.2/vault_1.19.2_linux_amd64.zip && unzip vault_1.19.2_linux_amd64.zip && sudo mv vault /usr/local/bin/ && rm vault_1.19.2_linux_amd64.zip"
  [consul]="curl -LO https://releases.hashicorp.com/consul/1.20.1/consul_1.20.1_linux_amd64.zip && unzip consul_1.20.1_linux_amd64.zip && sudo mv consul /usr/local/bin/ && rm consul_1.20.1_linux_amd64.zip"
